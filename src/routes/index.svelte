<script>
import { Card, CardText, CardActions, Button, MaterialApp, CardSubtitle } from 'svelte-materialify';
...
// 		setTimeout(() => {
// 			shownPositions.push(positions[i])
// 			console.log('shownPositions', shownPositions)
...
<div style="display: flex; align-items: center; justify-content: center; width: 800px; flex-wrap: wrap;">
